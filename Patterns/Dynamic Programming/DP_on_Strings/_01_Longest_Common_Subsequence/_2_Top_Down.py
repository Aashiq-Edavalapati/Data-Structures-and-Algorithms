...
def lcs(str1: str, str2: str) -> int:
    ...
    def solve(idx1: int, idx2: int) -> int:
        ...
        if dp[idx1][idx2] != -1: return dp[idx1][idx2] # If result was stored in DP table, then return it
                    
        if str1[idx1] == str2[idx2]:
            dp[idx1][idx2] = 1 + solve(idx1 - 1, idx2 - 1) # Store the result in DP table
            return dp[idx1][idx2]

        dp[idx1][idx2] = max(solve(idx1 - 1, idx2), solve(idx1, idx2 - 1)) # Store the result in DP table
        return dp[idx1][idx2]
